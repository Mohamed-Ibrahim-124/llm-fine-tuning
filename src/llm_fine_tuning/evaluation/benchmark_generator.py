...
class BenchmarkGenerator:
    ...
    def generate_benchmark_dataset(self) -> List[Dict[str, Any]]:
        ...
        for category in self.categories:
            for difficulty in self.difficulty_levels:
                questions_per_category = self.num_questions // (len(self.categories) * len(self.difficulty_levels))
                
                for _ in range(questions_per_category):
                    question_data = self._generate_question(category, difficulty, question_id)
    ...
    def _generate_question(self, category: str, difficulty: str, question_id: int) -> Dict[str, Any]:
